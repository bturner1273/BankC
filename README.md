The application is going to ask you to enter various credentials in order to operate the program. you won’t be able to access the features of the program without it.
Manager:
•    Username: manager
•    Password: password
